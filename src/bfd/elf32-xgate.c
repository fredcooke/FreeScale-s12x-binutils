...
static void
xgate_info_to_howto_rel (bfd *abfd ATTRIBUTE_UNUSED, arelent *cache_ptr,
...
static bfd_boolean
xgate_elf_build_one_stub (struct bfd_hash_entry *gen_entry ATTRIBUTE_UNUSED,
...
/* Hook called by the linker routine which adds symbols from an object
 file. */
bfd_boolean
elf32_xgate_add_symbol_hook (bfd *abfd,
    struct bfd_link_info *info ATTRIBUTE_UNUSED,
    Elf_Internal_Sym *sym ATTRIBUTE_UNUSED, const char **namep ATTRIBUTE_UNUSED,
    flagword *flagsp ATTRIBUTE_UNUSED, asection **secp ATTRIBUTE_UNUSED,
...
elf32_xgate_size_stubs (bfd *output_bfd, bfd *stub_bfd ATTRIBUTE_UNUSED,
    struct bfd_link_info *info ATTRIBUTE_UNUSED, asection *
    (*add_stub_section) (const char*, asection*) ATTRIBUTE_UNUSED)
{
  return FALSE;
}
...
static bfd_boolean
xgate_elf_export_one_stub (struct bfd_hash_entry *gen_entry ATTRIBUTE_UNUSED,
    void *in_arg ATTRIBUTE_UNUSED)
{
  return TRUE;
}
...
static void
xgate_elf_set_symbol (bfd *abfd ATTRIBUTE_UNUSED,
    struct bfd_link_info *info ATTRIBUTE_UNUSED,
    const char *name ATTRIBUTE_UNUSED, bfd_vma value ATTRIBUTE_UNUSED,
...
xgate_elf_ignore_reloc (bfd *abfd ATTRIBUTE_UNUSED, arelent *reloc_entry,
