...
/* Line 189 of yacc.c  */
#line 21 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
...
/* Line 214 of yacc.c  */
#line 282 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
...
/* Line 1455 of yacc.c  */
#line 309 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
...
/* Line 1455 of yacc.c  */
#line 315 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
...
/* Line 1455 of yacc.c  */
#line 322 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {}
    break;
...
/* Line 1455 of yacc.c  */
#line 335 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("ftype\n"));
...
/* Line 1455 of yacc.c  */
#line 340 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("addr\n"));
	    (yyval.num) = ADDR;
	  }
...
/* Line 1455 of yacc.c  */
#line 345 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("immed\n"));
	    (yyval.num) = IMMED;
	  }
...
/* Line 1455 of yacc.c  */
#line 353 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
...
/* Line 1455 of yacc.c  */
#line 362 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
...
/* Line 1455 of yacc.c  */
#line 366 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
...
/* Line 1455 of yacc.c  */
#line 370 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
...
/* Line 1455 of yacc.c  */
#line 377 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("flags=%d\n", (yyvsp[(2) - (2)].val)));
...
/* Line 1455 of yacc.c  */
#line 382 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    (yyval.val) = 0;
	  }
    break;
...
/* Line 1455 of yacc.c  */
#line 389 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
...
/* Line 1455 of yacc.c  */
#line 395 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    sbit = 31;
	    ebit = 0;
	  }
...
/* Line 1455 of yacc.c  */
#line 403 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("pnum=%d\n",(yyvsp[(1) - (1)].num)));
	    (yyval.num) = (yyvsp[(1) - (1)].num);
	  }
...
/* Line 1455 of yacc.c  */
#line 411 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("dreg\n"));
	    (yyval.num) = DREG;
	  }
...
/* Line 1455 of yacc.c  */
#line 416 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("creg\n"));
	    (yyval.num) = CREG;
	  }
...
/* Line 1455 of yacc.c  */
#line 421 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("greg\n"));
	    (yyval.num) = GREG;
	  }
...
/* Line 1455 of yacc.c  */
#line 429 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("name=%s\n",(yyvsp[(1) - (1)].str)));
...
/* Line 1455 of yacc.c  */
#line 445 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
    {
	    DBGL2 (("val=x%x\n",(yyvsp[(1) - (1)].num)));
	    (yyval.val) = (yyvsp[(1) - (1)].num);
	  }
...
/* Line 1675 of yacc.c  */
#line 450 "../binutils-2.20/binutils-2.20/gas/itbl-parse.y"
